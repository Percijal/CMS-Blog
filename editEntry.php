...
$sql = "SELECT * FROM wpis WHERE id = $gettedId";
$query = $conn -> query($sql);
$rows = $query -> fetchAll(PDO::FETCH_ASSOC);

$title = $rows[0]["title"];
$date = $rows[0]["date"];
$text = $rows[0]["mainText"];
...
if($ready){
    $titleNew = $_POST["entryTitle"];
    $textNew = $_POST["entryText"];
    $authorNew = $_POST["entryAuthor"];

    $sql = "UPDATE wpis SET title = '$titleNew', mainText = '$textNew', author = '$authorNew' WHERE id = $gettedId;";
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="d-flex col align-items-center items-center justify-content-center">
                <div class="test">
                    <fieldset>
                        <legend style="text-align: center; font-style: italic; font-weight: bold;">Edit</legend>
                        <form method="POST">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <input type="text" name="entryTitle" value="<?php echo $title; ?>" required>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <textarea id="w3review" name="entryText" rows="4" cols="40" placeholder="Here leave your text ..." required><?php echo $text; ?> </textarea>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <input type="text" name="entryAuthor" value="<?php echo $author; ?>" required>
                                </div>
                            </div>
                            <br>
                            <div class="row justify-content-sm-center">
                                <div class="col-auto col-sm-auto col-md-auto col-lg-auto">
                                    <input class="submitButton" type="submit" value="Update" class="registerButton">
                                    <br>
                                </div>
                            </div>
                        </form>
